    ...
    return (
        <div className="bg-gray-900 min-h-screen">
            <div className="inline-flex items-center pt-3">
                ...
                <label className="relative flex items-center px-0.5 cursor-pointer" htmlFor="caerleon-checkbox">
                ...
                <label className="relative flex items-center px-0.5 cursor-pointer" htmlFor="bridgewatch-checkbox">
                ...
                <label className="relative flex items-center px-0.5 cursor-pointer" htmlFor="fortsterling-checkbox">
                ...
                <label className="relative flex items-center px-0.5 cursor-pointer" htmlFor="lymhurst-checkbox">
                ...
                <label className="relative flex items-center px-0.5 cursor-pointer" htmlFor="martlock-checkbox">
                ...
                <label className="relative flex items-center px-0.5 cursor-pointer" htmlFor="thetfort-checkbox">
            ...
            <div className="flex items-center">
                <span className="text-white pl-3 px-0.5">Seleccionar Nivel:</span>
